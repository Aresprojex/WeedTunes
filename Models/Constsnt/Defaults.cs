...
namespace WeedTunes.Models.Constant
{
    public class Defaults
    {
        public const string SuperAdminEmail = "superadmin@weedtunes.com";
        ...
        public const string SysUserEmail = "systemuser@weedtunes.com";
        ...
        public const string AdminEmail = "admin@weedtunes.com";
        public const string AdminMobile = "07060882817";

        #region INCASE WE NEED THE GUID
