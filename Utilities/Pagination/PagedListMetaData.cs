...
namespace WeedTunes.Utilities.Pagination
{
    /// <summary>
    /// Non-enumerable version of the PagedList class.
    /// </summary>
    [Serializable]
    public class PagedListMetaData : WeedTunes.Utilities.Pagination.IPagedList
    {
        /// <summary>
        ...
        public PagedListMetaData(WeedTunes.Utilities.Pagination.IPagedList pagedList)
        {
